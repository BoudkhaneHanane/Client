...
const SignRevendeur = () => {
            ...
            <div className='signup-page'>
                ...
                <form onSubmit={handleSubmit} className='signup-form'>
                    <div className='form-group'>
                        ...
                        <input type='text' id='firstName' name='nom' value={formData.nom} onChange={handleChange} />
                        {errors.nom && <p>{errors.nom}</p>}
                    </div>
                    <div className='form-group'>
                        <label htmlFor='lastName'>Last Name</label>
                        <input type='text' id='lastName' name='prenom' value={formData.prenom} onChange={handleChange} />
                        {errors.prenom && <p>{errors.prenom}</p>}
                    </div>
                    <div className='form-group'>
                        <label htmlFor='address'>Address</label>
                        <input type='text' id='address' name='adresse' value={formData.adresse} onChange={handleChange} />
                        {errors.adresse && <p>{errors.adresse}</p>}
                    </div>
                    <div className='form-group'>
                        <label htmlFor='phoneNumber'>Phone Number</label>
                        <input type='text' id='phoneNumber' name='numero_telephone' value={formData.numero_telephone} onChange={handleChange} />
                    ...
                    <div className='form-group'>
                        ...
                        <input type='date' id='birthDate' name='Date_anniversaire' value={formData.Date_anniversaire} onChange={handleChange} />
    ...
    <input type='password' id='password' name='password' value={formData.password} onChange={handleChange} autoComplete="new-password" />

    {errors.password && <p>{errors.password}</p>}
</div>
<div className='form-group'>
    <label htmlFor='confirmPassword'>Confirm Password</label>
    <input type='password' id='confirmPassword' name='confirmPassword' value={formData.confirmPassword} onChange={handleChange} autoComplete="new-password" />
                    ...
                    {formData.devenirRevendeur && (
                        <>
                            ...
                            <div className='form-group'>
                                ...
                                <input type='text' id='businessRegistration' name='businessRegistration' value={formData.businessRegistration} onChange={handleChange} />
                            ...
                            <div className='form-group'>
                                ...
                                <input type='text' id='taxIdentificationNumber' name='taxIdentificationNumber' value={formData.taxIdentificationNumber} onChange={handleChange} />
                                {errors.taxIdentificationNumber && <p>{errors.taxIdentificationNumber}</p>}
                            </div>
                            <div className='form-group'>
                                <label htmlFor='taxArticle'>Tax Article</label>
                                <input type='text' id='taxArticle' name='taxArticle' value={formData.taxArticle} onChange={handleChange} />
